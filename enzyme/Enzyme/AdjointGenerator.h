  ...
  void handleAdjointForIntrinsic(Intrinsic::ID ID, llvm::Instruction &I,
    ...
    case DerivativeMode::ForwardMode: {
...
#endif
      {
        ...
        //
        //          if (!gutils->isConstantValue(orig_ops[0])) {
        //            addToDiffe(orig_ops[0], vdiff, Builder2,
        //            orig_ops[0]->getType());
        //          }
        //          if (!gutils->isConstantValue(orig_ops[1])) {
        //            auto und = UndefValue::get(orig_ops[1]->getType());
        ...
        //#endif
        //            auto vec = Builder2.CreateShuffleVector(
        //                                                    Builder2.CreateInsertElement(und,
        //                                                    vdiff,
        //                                                    (uint64_t)0), und,
        //                                                    mask);
        //            addToDiffe(orig_ops[1], vec, Builder2,
        //            orig_ops[0]->getType());
        //          }
        return;
      }
      ...
      case Intrinsic::sqrt: {
        ...
        if (op && !gutils->isConstantValue(orig_ops[0])) {
          ...
          Value *dif0 = Builder2.CreateFDiv(
              Builder2.CreateFMul(ConstantFP::get(I.getType(), 0.5), op),
              cal);
